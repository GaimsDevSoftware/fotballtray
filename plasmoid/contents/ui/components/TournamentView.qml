    ...
    ColumnLayout {
        ...
        ScrollView {
            ...
            RowLayout {
                ...
                height: scorersScroll.availableHeight
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        RowLayout {
                            ...
                            Kirigami.Heading { text: modelData.team || modelData.countryCode || ""; visible: !!modelData.team; level: 6; color: Kirigami.Theme.disabledTextColor; Layout.preferredWidth: modelData.team ? 120 : 0; elide: Text.ElideRight }
                            Rectangle {
